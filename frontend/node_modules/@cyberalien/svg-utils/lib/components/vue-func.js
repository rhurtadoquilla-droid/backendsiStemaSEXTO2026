...
function createVueFunctionalComponent(data, options) {
	...
	if (fallback) {
		imports.named["@iconify/css-vue"] = /* @__PURE__ */ new Set(["Icon"]);
		dependencies.add("@iconify/css-vue");
	}
	const vueNamedImports = /* @__PURE__ */ new Set(["defineComponent", "h"]);
	...
	let stringifiedContent = stringifyFactoryIconContent(icon, isEmbeddedCSS ? style : void 0);
	if (!fallback) {
	...
	props[fallback ? "content" : "innerHTML"] = { value: fallback ? stringifiedContent : "innerHTML" };
